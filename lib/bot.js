...
function doSearch(splits, self, apis, requests) {
  ...
  var optional = {"maxResults": 10***REMOVED***
  try {
  ...
  ***REMOVED***);
        /*if (self.config.verbose) {
         console.log(fullMsg);
   ***REMOVED****/
        var req = {"channel": chan, "text": fullMsg, "type": "search"***REMOVED***
        def.resolve(req)
***REMOVED*** else {
        console.log(error);
        var req = {"channel": null, "text": "There was an error executing your search: " + error, "type": "error"***REMOVED***
        def.resolve(req);
***REMOVED***
    });
  } catch (e) {
    var req = {"channel": null, "text": "There was an error executing your search: " + e, "type": "error"***REMOVED***
    def.resolve(req);
  }
          ...
          try {
            ...
            ***REMOVED***
                  ...
                  if (verbose) {
                    console.log(msg);
            ***REMOVED***
                  var req = {"channel": message.channel, "text": msg, "type": "issue"***REMOVED***
                  def.resolve(req);
          ***REMOVED***);
        ***REMOVED***)(q.defer(), j);
      ***REMOVED*** else {
            ...
            ***REMOVED***
                  var req = {"channel": message.channel, "text": msg***REMOVED***
                  def.resolve(req);
          ***REMOVED***)
