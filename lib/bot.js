...
function doSearch(splits, self, apis, requests) {
  ...
  ***REMOVED***);
        if (self.config.verbose) {
          console.log(fullMsg);
  ***REMOVED***
        var req = {"channel": chan, "text": fullMsg***REMOVED***
        def.resolve(req)
***REMOVED*** else {
        console.log(error);
        var req = {"channel": null, "text": "There was an error executing your search: " + error***REMOVED***
        def.resolve(req);
***REMOVED***
    });
  } catch (e) {
    var req = {"channel": null, "text": "There was an error executing your search: " + e***REMOVED***
    def.resolve(req);
  }
          ...
          try {
            ...
            ***REMOVED***
                  if (verbose) {
                    console.log(msg);
            ***REMOVED***
                  var req = {"channel": message.channel, "text": fullMsg***REMOVED***
                  def.resolve(req);
          ***REMOVED***);
        ***REMOVED***)(q.defer(), j);
      ***REMOVED*** else {
